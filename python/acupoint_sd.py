            ...
            while k + 14 <= data_len:
                ...
                # 收到“未进入文件操作模式命令”
                    ...
                    if data_len-k == data_bytes[k + 3]+3:
                        ...
                        break
                # 收到主机目前正在搜索的蓝牙名称
                elif data_bytes[k] == 0XEE and data_bytes[k + 1] == 0X88 and data_bytes[k + 12] == 0XEE and data_bytes[k + 13] == 0X77:
                    name_buffer = ""
                    for k5 in range(10):
...
class MainWidget(QtWidgets.QMainWindow):
    ...
    def __init__(self):
        ...
        main_layout.addWidget(self.acupoint_name_select, 6, 8, 1, 2, alignment=Qt.AlignCenter)
        ...
        main_layout.addWidget(self.refreshButton, 6, 10, 1, 2, alignment=Qt.AlignCenter)
        ...
        main_layout.addWidget(self.updateButton, 6, 12, 1, 2, alignment=Qt.AlignCenter)
...
if __name__ == "__main__":
    ...
    mSerial = serial.Serial('COM7', 115200)
    if mSerial.isOpen():
        print("open success")
